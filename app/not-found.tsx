      ...
      <div className='container mx-auto min-h-screen px-6 py-12 lg:flex lg:items-center lg:gap-12'>
        <div className='wf-ull lg:w-1/2'>
          ...
          <div className='mt-6 flex items-center gap-x-3'>
            ...
            <button className='w-1/2 shrink-0 rounded-lg bg-red-500 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 sm:w-auto'>
              Take me home
            </button>
          </div>
        </div>
